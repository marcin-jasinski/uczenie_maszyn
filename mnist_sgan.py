...
def summarize_performance(step, g_model, c_model, latent_dim, dataset, n_samples=100):
	...
	print('[INFO] Classifier acc score after step %d: %.3f%%' % (step, (acc * 100)))
...
def train(g_model, d_model, c_model, gan_model, dataset, latent_dim, samples_per_class, n_epochs=20, n_batch=100):
	...
	print('[INFO] n_epochs=%d, n_batch=%d, 1/2=%d, b/e=%d, steps=%d' % (n_epochs, n_batch, half_batch, bat_per_epo, n_steps))
